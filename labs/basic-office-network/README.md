...
My objective for this lab was to build and configure a small office network using Cisco Packet Tracer. The lab focused on static IP addressing, router interface configuration and verifying communication between devices.
...
| PC4    | NIC       | 192.168.2.11 | 255.255.255.0 | 192.168.1.1     |
```
